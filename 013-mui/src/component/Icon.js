...
const FontIconExampleIcons = () => (
  <div>
    ...
    <FontIcon className="material-icons" style={iconStyles} color={blue500}>visibility</FontIcon>
    <FontIcon className="material-icons" style={iconStyles}>favorite</FontIcon>
  </div>
);
